...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "d:\\XAMPP\\htdocs\\course\\src\\app.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-67a2dd4d&file=app.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-67a2dd4d&file=app.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-d47db0d0&file=index.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-d47db0d0&file=index.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\home.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5cf3bd09&file=home.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./home.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5cf3bd09&file=home.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./home.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".nav.nav-pills> li a.active {\r\n    color: #fff;\r\n    background-color: #337ab7 !important;\r\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         <ul class="nav nav-pills nav-stacked" v-if="position == 1">
	
	//             <li role="presentation"><a v-link="{ path: '/index/home/choose', activeClass: 'active'}">开始选课</a></li>
	
	//             <li role="presentation"><a v-link="{ path: '/index/home/result', activeClass: 'active'}">查看选课结果</a></li>
	
	//             <li role="presentation"><a v-link="{ path: '/index/home/hasLearn', activeClass: 'active'}">已修课程</a></li>
	
	//         </ul>
	
	//         <ul class="nav nav-pills nav-stacked" v-else>
	
	//             <li role="presentation"><a v-link="{ path: '/index/home/teach', activeClass: 'active'}">我的课程列表</a></li>
	
	//             <li role="presentation"><a v-link="{ path: '/index/home/addLesson', activeClass: 'active'}">添加课程</a></li>
	...
	module.exports = {
	    data: function data() {
	        var currentUser = AV.User.current();
	        var position = currentUser.get("position");
	        return {
	            position: position
	        };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\welcome.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-18bd3ea8&file=welcome.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./welcome.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-18bd3ea8&file=welcome.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./welcome.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	//     <h3 style="text-align: center">欢迎进入选课系统!</h3>
...
/***/ function(module, exports) {
	...
	module.exports = "<h3 style=\"text-align: center\">欢迎进入选课系统!</h3>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\student\\choose.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\student\\result.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\student\\hasLearn.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\teacher\\teach.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\teacher\\addLesson.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	module.exports = {
	    ...
	    methods: {
	        addLesson: function addLesson() {
	            ...
	            lesson.save(null, {
	                success: function success(lesson) {
	                    alert("添课成功！");
	                ...
	                error: function error(lesson, _error) {
	                    console.log('Failed to create new object, with error message: ' + _error.message);
	                }
	            });
	        }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\teacher\\lesson.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\about.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "<p>软件体系结构课程设计。<a href=\"https://github.com/husterxsp/vue-demo\">源代码</a></p>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "d:\\XAMPP\\htdocs\\course\\components\\login.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5f68caaf&file=login.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./login.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5f68caaf&file=login.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./login.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         <h2 class="form-signin-heading">选课系统</h2>
	
	//         <input type="text" v-model="username" class="form-control" placeholder="学号/工号" required autofocus>
	
	//         <input type="password" v-model="password" class="form-control" placeholder="密码 000000" required>
	
	//         <button class="btn btn-lg btn-primary btn-block" v-on:click="login(username, password)">登录</button>
	
	//         <p>测试账号(用户名/密码): </p>
	
	//         <p>学生: U201300000/000000</p>
	
	//         <p>老师: T201300000/000000</p>
